...
// Azure AI Services (Foundry) – enables project management for Agent Framework
...
module searchReaderRoleAIS 'core/security/role.bicep' = {
  scope: rg
...
module searchContribRoleAIS 'core/security/role.bicep' = {
  scope: rg
...
module storageRoleAIS 'core/security/role.bicep' = {
  scope: rg
...
// RBAC – Project Managed Identity → Search & Storage
module searchReaderRoleProject 'core/security/role.bicep' = {
  scope: rg
...
module searchContribRoleProject 'core/security/role.bicep' = {
  scope: rg
...
module storageRoleProject 'core/security/role.bicep' = {
  scope: rg
